function a(a) {
var b = $("<div>", {"class": a}).appendTo("body"), c = b.css("background-color");
return b.remove(), c
}
var color_primary = a("clr-primary"), color_success = a("clr-success"), color_info = a("clr-info"), color_warning = a("clr-warning"), color_danger = a("clr-danger"), color_alt1 = a("clr-alt1"), color_alt2 = a("clr-alt2"), color_alt3 = a("clr-alt3"), color_alt4 = a("clr-alt4");
...
var App = function () {
    ...
    function b() {
        ...
        function c(a) {
            ...
            "undefined" != typeof a && (b = a), $.each(b, function (a, b) {
                var c = $(this).find("> a span").html(), d = $(this).find("> ul"), e = $("> li", d), c = $('<li class="title">' + c + "</li>"), f = $('<li class="nav-items"><div class="am-scroller nano"><div class="content nano-content"><ul></ul></div></div></li>');
        ...
        if (e.on("mouseover", function () {
                var a = $(this).parent().find(".am-scroller"), b = $(this).parent(), d = b.find("> ul");
                $.isXs() || ($("ul.visible", m).removeClass("visible"), d.addClass("visible")), a.nanoScroller({destroy: !0}), a.nanoScroller(), i.syncSubMenuOnHover && c(b)
                ...
                if ($.isXs()) {
                    var b, c = $(this), d = i.leftSidebarSlideSpeed, e = c.parent(), f = c.next();
                    ...
                    g.addClass("hide"), setTimeout(function () {
                        g.removeClass("hide")
                    }, 50)
                }
        ...
        $(window).resize(function () {
            p(function () {
                if (!$.isXs()) {
                    var a = $(".am-scroller");
                    a.nanoScroller({destroy: !0}), a.nanoScroller()
                }
    ...
    function f() {
        ...
        function c(a, b) {
            ...
            "" != a && ($('<div class="msg">' + a + "</div>").appendTo(c), c.appendTo(i), j.stop().animate({scrollTop: j.prop("scrollHeight")}, 900, "swing"), g())
        }

        var d = $(".am-right-sidebar .tab-pane.chat"), e = $(".chat-contacts", d), f = $(".chat-window", d), h = $(".chat-messages", f), i = $(".content > ul", h), j = $(".nano-content", h), k = $(".chat-input", f), l = $("input", k), m = $(".send-msg", k);
        $(".user a", e).on("click", function (b) {
            $(".am-scroller", e).nanoScroller({stop: !0}), a(), b.preventDefault()
        }), $(".title .return", f).on("click", function (a) {
            b(), g()
        }), l.keypress(function (a) {
            var b = a.keyCode ? a.keyCode : a.which, d = $(this).val();
    ...
    function h() {
        var a = 220, b = 500, c = $('<div class="am-scroll-top"></div>');
    ...
    }, j = {}, k = $("body"), l = $(".am-wrapper"), m = $(".am-left-sidebar"), n = $(".am-right-sidebar"), o = !1, p = function () {
        var a = {};
    ...
    return {
        conf: i, color: j, init: function (d) {
...
}(), deviceIsAndroid = navigator.userAgent.indexOf("Android") > 0, deviceIsIOS = /iP(ad|hone|od)/.test(navigator.userAgent), deviceIsIOS4 = deviceIsIOS && /OS 4_\d(_\d)?/.test(navigator.userAgent), deviceIsIOSWithBadTarget = deviceIsIOS && /OS ([6-9]|\d{2})_\d/.test(navigator.userAgent), deviceIsBlackBerry10 = navigator.userAgent.indexOf("BB10") > 0;
FastClick.prototype.needsClick = function (a) {
    ...
    function d(a, b, c) {
        ...
        var d, e, f = P(a, b, c), g = O(a, b, c), h = (f + g) / 2;
        if (f == g)d = e = 0; else {
            var i = f - g;
    ...
    function f(a, b, c) {
        a = y(a, 255), b = y(b, 255), c = y(c, 255);
        var d, e, f = P(a, b, c), g = O(a, b, c), h = f, i = f - g;
    ...
    function g(a, b, c) {
        ...
        var d = M.floor(a), e = a - d, f = c * (1 - b), g = c * (1 - e * b), h = c * (1 - (1 - e) * b), i = d % 6, j = [c, g, f, f, h, c][i], k = [h, c, c, g, f, f][i], l = [f, f, h, c, c, g][i];
    ...
    function r(b) {
        ...
        return [a(b), a({h: (d + 120) % 360, s: c.s, l: c.l}), a({h: (d + 240) % 360, s: c.s, l: c.l})]
    }

    function s(b) {
        var c = a(b).toHsl(), d = c.h;
        return [a(b), a({h: (d + 90) % 360, s: c.s, l: c.l}), a({
            h: (d + 180) % 360,
            s: c.s,
            l: c.l
    ...
    function t(b) {
        var c = a(b).toHsl(), d = c.h;
        return [a(b), a({h: (d + 72) % 360, s: c.s, l: c.l}), a({h: (d + 216) % 360, s: c.s, l: c.l})]
    }
    ...
    function H(a) {
        ...
        return (c = T.rgb.exec(a)) ? {r: c[1], g: c[2], b: c[3]} : (c = T.rgba.exec(a)) ? {
            ...
            l: c[3],
            a: c[4]
        } : (c = T.hsv.exec(a)) ? {h: c[1], s: c[2], v: c[3]} : (c = T.hsva.exec(a)) ? {
            h: c[1],
            s: c[2],
            v: c[3],
            a: c[4]
    ...
    var J = /^[\s,#]+/, K = /\s+$/, L = 0, M = Math, N = M.round, O = M.min, P = M.max, Q = M.random;
    a.prototype = {
        isDark: function () {
            ...
            var a = f(this._r, this._g, this._b), b = N(360 * a.h), c = N(100 * a.s), d = N(100 * a.v);
            ...
            var a = d(this._r, this._g, this._b), b = N(360 * a.h), c = N(100 * a.s), e = N(100 * a.l);
    ...
    function c(b, c) {
        function d(b) {
            if (!(ja() || a(b.target).closest(c.excludedElements, Ra).length > 0)) {
                var d, e = b.originalEvent ? b.originalEvent : b, f = e.touches, g = f ? f[0] : e;
                return Sa = v, f ? Ta = f.length : c.preventDefaultEvents !== !1 && b.preventDefault(), Ia = 0, Ja = null, Pa = null, Ka = 0, La = 0, Ma = 0, Na = 1, Oa = 0, Qa = qa(), ha(), la(0, g), !f || Ta === c.fingers || c.fingers === t || R() ? (Va = za(), 2 == Ta && (la(1, f[1]), La = Ma = ta(Ua[0].start, Ua[1].start)), (c.swipeStatus || c.pinchStatus) && (d = J(e, Sa))) : d = !1, d === !1 ? (Sa = y, J(e, Sa), d) : (c.hold && (_a = setTimeout(a.proxy(function () {
        ...
        function D(a) {
            ...
            if (Sa !== x && Sa !== y && !ia()) {
                var d, e = b.touches, f = e ? e[0] : b, g = ma(f);
                if (Wa = za(), e && (Ta = e.length), c.hold && clearTimeout(_a), Sa = w, 2 == Ta && (0 == La ? (la(1, e[1]), La = Ma = ta(Ua[0].start, Ua[1].start)) : (ma(e[1]), Ma = ta(Ua[0].end, Ua[1].end), Pa = va(Ua[0].end, Ua[1].end)), Na = ua(La, Ma), Oa = Math.abs(La - Ma)), Ta === c.fingers || c.fingers === t || !e || R()) {
                    if (Ja = ya(g.start, g.end), P(a, Ja), Ia = wa(g.start, g.end), Ka = sa(), oa(Ja, Ia), (c.swipeStatus || c.pinchStatus) && (d = J(b, Sa)), !c.triggerOnTouchEnd || c.triggerOnTouchLeave) {
                        ...
                        !c.triggerOnTouchEnd && h ? Sa = I(w) : c.triggerOnTouchLeave && !h && (Sa = I(x)), (Sa == y || Sa == x) && J(b, Sa)
                    }
                } else Sa = y, J(b, Sa);
                d === !1 && (Sa = y, J(b, Sa))
            }
        ...
        function E(a) {
            var b = a.originalEvent ? a.originalEvent : a, d = b.touches;
            if (d) {
                if (d.length && !ia())return ga(), !0;
                if (d.length && ia())return !0
            }
            return ia() && (Ta = Ya), Wa = za(), Ka = sa(), M() || !L() ? (Sa = y, J(b, Sa)) : c.triggerOnTouchEnd || 0 == c.triggerOnTouchEnd && Sa === w ? (c.preventDefaultEvents !== !1 && a.preventDefault(), Sa = x, J(b, Sa)) : !c.triggerOnTouchEnd && Y() ? (Sa = x, K(b, Sa, o)) : Sa === w && (Sa = y, J(b, Sa)), ka(!1), null
        }
        ...
        function G(a) {
            var b = a.originalEvent ? a.originalEvent : a;
            c.triggerOnTouchLeave && (Sa = I(x), J(b, Sa))
        }

        function H() {
            Ra.unbind(Da, d), Ra.unbind(Ha, F), Ra.unbind(Ea, D), Ra.unbind(Fa, E), Ga && Ra.unbind(Ga, G), ka(!1)
        }
        ...
        function J(a, b) {
            var c, d = a.touches;
            return V() && U() || S() && R() ? (V() && U() && (c = K(a, b, m)), S() && R() && c !== !1 && (c = K(a, b, n))) : ea() && c !== !1 ? c = K(a, b, p) : fa() && c !== !1 ? c = K(a, b, q) : da() && c !== !1 && (c = K(a, b, o)), b === y && (U() && (c = K(a, b, m)), R() && (c = K(a, b, n)), F(a)), b === x && (d ? d.length || F(a) : F(a)), c
        }

        function K(b, d, k) {
            var l;
            if (k == m) {
                if (Ra.trigger("swipeStatus", [d, Ja || null, Ia || 0, Ka || 0, Ta, Ua]), c.swipeStatus && (l = c.swipeStatus.call(Ra, b, d, Ja || null, Ia || 0, Ka || 0, Ta, Ua), l === !1))return !1;
                if (d == x && T()) {
                    if (Ra.trigger("swipe", [Ja, Ia, Ka, Ta, Ua]), c.swipe && (l = c.swipe.call(Ra, b, Ja, Ia, Ka, Ta, Ua), l === !1))return !1;
                    switch (Ja) {
                        case e:
                            Ra.trigger("swipeLeft", [Ja, Ia, Ka, Ta, Ua]), c.swipeLeft && (l = c.swipeLeft.call(Ra, b, Ja, Ia, Ka, Ta, Ua));
                            break;
                        case f:
                            Ra.trigger("swipeRight", [Ja, Ia, Ka, Ta, Ua]), c.swipeRight && (l = c.swipeRight.call(Ra, b, Ja, Ia, Ka, Ta, Ua));
                            break;
                        case g:
                            Ra.trigger("swipeUp", [Ja, Ia, Ka, Ta, Ua]), c.swipeUp && (l = c.swipeUp.call(Ra, b, Ja, Ia, Ka, Ta, Ua));
                            break;
                        case h:
                            Ra.trigger("swipeDown", [Ja, Ia, Ka, Ta, Ua]), c.swipeDown && (l = c.swipeDown.call(Ra, b, Ja, Ia, Ka, Ta, Ua))
                    }
                }
            }
            if (k == n) {
                if (Ra.trigger("pinchStatus", [d, Pa || null, Oa || 0, Ka || 0, Ta, Na, Ua]), c.pinchStatus && (l = c.pinchStatus.call(Ra, b, d, Pa || null, Oa || 0, Ka || 0, Ta, Na, Ua), l === !1))return !1;
                if (d == x && Q())switch (Pa) {
                    case i:
                        Ra.trigger("pinchIn", [Pa || null, Oa || 0, Ka || 0, Ta, Na, Ua]), c.pinchIn && (l = c.pinchIn.call(Ra, b, Pa || null, Oa || 0, Ka || 0, Ta, Na, Ua));
                        break;
                    case j:
                        Ra.trigger("pinchOut", [Pa || null, Oa || 0, Ka || 0, Ta, Na, Ua]), c.pinchOut && (l = c.pinchOut.call(Ra, b, Pa || null, Oa || 0, Ka || 0, Ta, Na, Ua))
                }
            }
            return k == o ? (d === y || d === x) && (clearTimeout($a), clearTimeout(_a), Z() && !aa() ? (Za = za(), $a = setTimeout(a.proxy(function () {
                Za = null, Ra.trigger("tap", [b.target]), c.tap && (l = c.tap.call(Ra, b, b.target))
            }, this), c.doubleTapThreshold)) : (Za = null, Ra.trigger("tap", [b.target]), c.tap && (l = c.tap.call(Ra, b, b.target)))) : k == p ? (d === y || d === x) && (clearTimeout($a), Za = null, Ra.trigger("doubletap", [b.target]), c.doubleTap && (l = c.doubleTap.call(Ra, b, b.target))) : k == q && (d === y || d === x) && (clearTimeout($a), Za = null, Ra.trigger("longtap", [b.target]), c.longTap && (l = c.longTap.call(Ra, b, b.target))), l
        }
        ...
        function N() {
            return null !== c.pinchThreshold ? Oa >= c.pinchThreshold : !0
        }

        function O() {
            var a;
            return a = c.maxTimeThreshold && Ka >= c.maxTimeThreshold ? !1 : !0
        }

        function P(a, b) {
            if (c.preventDefaultEvents !== !1)if (c.allowPageScroll === k)a.preventDefault(); else {
        ...
        function T() {
            var a = O(), b = L(), c = W(), d = X(), e = M(), f = !e && d && c && b && a;
            return f
        }
        ...
        function W() {
            return Ta === c.fingers || c.fingers === t || !z
        }
        ...
        function ba() {
            return (1 === Ta || !z) && (isNaN(Ia) || Ia < c.threshold)
        }

        function ca() {
            return Ka > c.longTapThreshold && u > Ia
        }
        ...
        function ja() {
            return !(Ra.data(C + "_intouch") !== !0)
        }

        function ka(a) {
            a === !0 ? (Ra.bind(Ea, D), Ra.bind(Fa, E), Ga && Ra.bind(Ga, G)) : (Ra.unbind(Ea, D, !1), Ra.unbind(Fa, E, !1), Ga && Ra.unbind(Ga, G, !1)), Ra.data(C + "_intouch", a === !0)
        }

        function la(a, b) {
            var c = {start: {x: 0, y: 0}, end: {x: 0, y: 0}};
            return c.start.x = c.end.x = b.pageX || b.clientX, c.start.y = c.end.y = b.pageY || b.clientY, Ua[a] = c, c
        }

        function ma(a) {
            var b = void 0 !== a.identifier ? a.identifier : 0, c = na(b);
        ...
        function pa(a) {
            return Qa[a] ? Qa[a].distance : void 0
        }
    ...
    var d = "1.6.12", e = "left", f = "right", g = "up", h = "down", i = "in", j = "out", k = "none", l = "auto", m = "swipe", n = "pinch", o = "tap", p = "doubletap", q = "longtap", r = "horizontal", s = "vertical", t = "all", u = 10, v = "start", w = "move", x = "end", y = "cancel", z = "ontouchstart" in window, A = window.navigator.msPointerEnabled && !window.navigator.pointerEnabled, B = window.navigator.pointerEnabled || window.navigator.msPointerEnabled, C = "TouchSwipe", D = {
        fingers: 1,
        threshold: 75,
    ...
    a.fn.swipe = function (c) {
        ...
        } else if (e && "object" == typeof c)e.option.apply(this, arguments); else if (!(e || "object" != typeof c && c))return b.apply(this, arguments);
        return d
        ...
        PHASE_END: x,
        PHASE_CANCEL: y
    }, a.fn.swipe.directions = {LEFT: e, RIGHT: f, UP: g, DOWN: h, IN: i, OUT: j}, a.fn.swipe.pageScroll = {
        NONE: k,
        HORIZONTAL: r,
        VERTICAL: s,
        AUTO: l
    ...
    a.isBreakpoint = function (b) {
        var c, d;
        return c = a("<div/>", {"class": "visible-" + b}).appendTo("body"), d = c.is(":visible"), c.remove(), d
    }, a.extend(a, {
        isXs: function () {
...
var App = function () {
    ...
    return App.chartsMorris = function () {
        function a() {
            var a = App.color.primary, b = tinycolor(App.color.primary).lighten(15).toString();
            new Morris.Line({
                element: "line-chart",
                data: e,
                xkey: "period",
        ...
        function b() {
            var a = tinycolor(App.color.alt3).lighten(15).toString(), b = tinycolor(App.color.alt3).brighten(3).toString();
            Morris.Bar({
                element: "bar-chart",
        ...
        function c() {
            var a = App.color.alt2, b = (App.color.alt4, App.color.alt3), c = App.color.alt1, d = tinycolor(App.color.primary).lighten(5).toString();
            Morris.Donut({
                element: "donut-chart",
                data: [{label: "Facebook", value: 25}, {label: "Google", value: 40}, {
                    label: "Twitter",
                    value: 25
        ...
        function d() {
            var a = App.color.alt2, b = (App.color.alt4, App.color.alt3, App.color.alt1), c = tinycolor(App.color.primary).lighten(5).toString();
            Morris.Area({
                element: "area-chart",
        ...
        var e = [{period: "2013", licensed: 400, sorned: 550}, {
            period: "2012",
            licensed: 450,
            sorned: 400
    ...
    return App.chartsSparklines = function () {
        var a = tinycolor(App.color.primary), b = tinycolor(App.color.alt1), c = tinycolor(App.color.alt2), d = tinycolor(App.color.alt3), e = a.toString(), f = b.toString(), g = c.toString(), h = d.toString();
        $.fn.sparkline.defaults.common.lineColor = e, $.fn.sparkline.defaults.common.fillColor = a.setAlpha(.3).toString(), $.fn.sparkline.defaults.line.spotColor = e, $.fn.sparkline.defaults.line.minSpotColor = e, $.fn.sparkline.defaults.line.maxSpotColor = e, $.fn.sparkline.defaults.line.highlightSpotColor = e, $.fn.sparkline.defaults.line.highlightLineColor = e, $.fn.sparkline.defaults.bar.barColor = e, $.fn.sparkline.defaults.bar.negBarColor = f, $.fn.sparkline.defaults.bar.stackedBarColor[0] = e, $.fn.sparkline.defaults.bar.stackedBarColor[1] = f, $.fn.sparkline.defaults.tristate.posBarColor = e, $.fn.sparkline.defaults.tristate.negBarColor = f, $.fn.sparkline.defaults.discrete.thresholdColor = f, $.fn.sparkline.defaults.bullet.targetColor = e, $.fn.sparkline.defaults.bullet.performanceColor = f, $.fn.sparkline.defaults.bullet.rangeColors[0] = b.setAlpha(.2).toString(), $.fn.sparkline.defaults.bullet.rangeColors[1] = b.setAlpha(.5).toString(), $.fn.sparkline.defaults.bullet.rangeColors[2] = b.setAlpha(.45).toString(), $.fn.sparkline.defaults.pie.sliceColors[0] = e, $.fn.sparkline.defaults.pie.sliceColors[1] = f, $.fn.sparkline.defaults.pie.sliceColors[2] = g, $.fn.sparkline.defaults.box.medianColor = e, $.fn.sparkline.defaults.box.boxFillColor = b.setAlpha(.5).toString(), $.fn.sparkline.defaults.box.boxLineColor = e, $.fn.sparkline.defaults.box.whiskerColor = h, $(".compositebar").sparkline("html", {
            ...
            type: "pie",
            height: "1.0em"
        }), $(".sparkboxplot").sparkline("html", {type: "box"}), $("#line-chart").sparkline([4, 3.5, 5, 7, 9, 9, 8, 7, 6, 6, 5, 7, 8, 4, 3, 4, 4, 5, 6, 7, 5, 6, 7, 8, 8.2, 7.5, 7.4, 7.2, 7], {
            width: "100%",
            height: "220px",
            lineWidth: 1.7,
            spotRadius: 3,
    ...
    return App.charts = function () {
            ...
            $.plot($("#line-chart1"), [{
                ...
                series: {
                    lines: {
                        ...
                        lineWidth: 2,
                        fill: !0,
                        fillColor: {colors: [{opacity: .2}, {opacity: .2}]}
        ...
        function d() {
            var a = [{label: "Google", data: 45}, {label: "Dribbble", data: 25}, {
                label: "Twitter",
                data: 20
            }, {
                label: "Facebook",
                data: 10
            }], b = tinycolor(App.color.primary).brighten(9).toString(), c = tinycolor(App.color.primary).lighten(13).toString(), d = tinycolor(App.color.primary).lighten(20).toString(), e = tinycolor(App.color.primary).lighten(27).toString();
            $.plot("#pie-chart4", a, {
                series: {
                    pie: {
                        show: !0,
                ...
                }, grid: {hoverable: !0, clickable: !0}, colors: [b, c, d, e], legend: {show: !1}
            })
        }
        ...
        function f() {
            var a = [{label: "Premium Purchases", data: 15}, {label: "Standard Plans", data: 25}, {
                label: "Services",
                data: 60
            }], b = tinycolor(App.color.primary).lighten(5).toString(), c = App.color.alt2, d = App.color.alt1, e = $("#widget-top-1").parent().next().find(".legend");
            $.plot("#widget-top-1", a, {
                series: {pie: {show: !0, highlight: {opacity: .1}}},
                grid: {hoverable: !0},
                legend: {container: e},
                colors: [b, c, d]
            })
        ...
        function g() {
            var a = tinycolor(App.color.alt1).lighten(7).toString(), b = App.color.alt1, c = [[1, 20], [2, 60], [3, 35], [4, 70], [5, 45]], d = [[1, 60], [2, 20], [3, 65], [4, 35], [5, 65]];
            $.plot("#linechart-mini1", [{data: c, canvasRender: !0}, {
                data: d,
                canvasRender: !0
            }], {
                series: {
        ...
        function h() {
            ...
            var c = App.color.alt2, d = [], e = 300, f = 30, g = $.plot("#live-data", [a()], {
                series: {
                    shadowSize: 0,
                    lines: {show: !0, lineWidth: 2, fill: !0, fillColor: {colors: [{opacity: .2}, {opacity: .2}]}}
                },
                grid: {
                    show: !0,
        ...
        function i() {
            ...
            $.plot($("#line-chart-live"), [{
                ...
                series: {
                    ...
                    }, fillColor: "rgba(0, 0, 0, 1)", points: {show: !1, fill: !0}, shadowSize: 0
                },
                legend: {show: !1},
                grid: {
                    show: !0,
        ...
        function j() {
            var a = App.color.alt3, b = $("#line-chart2"), c = b.parent().find(".counter .value").get(0), d = [[1, 10], [2, 30], [3, 55], [4, 36], [5, 57], [6, 80], [7, 65], [8, 50], [9, 80], [10, 70], [11, 90], [12, 67], [12, 67]], e = ($.plot("#line-chart2", [{
                data: d,
                showLabels: !0,
                label: "New Visitors",
                labelPlacement: "below",
                ...
                series: {
                    ...
                    }, fillColor: "rgba(0, 0, 0, 1)", points: {show: !0, fill: !0, fillColor: a}, shadowSize: 0
                },
                legend: {show: !1},
                grid: {
                    show: !1,
                ...
                xaxis: {autoscaleMargin: 0, ticks: 11, tickDecimals: 0},
                yaxis: {autoscaleMargin: .5, ticks: 5, tickDecimals: 0}
            }), new CountUp(c, 0, 80, 0, 2.5, {suffix: "%"}));
            e.start()
        }
        ...
        function l() {
            var a = App.color.alt3, b = tinycolor(App.color.alt3).lighten(22).toString();
            $.plot($("#bar-chart2"), [{
    ...
    return App.dashboard = function () {
        ...
        function c() {
            var a = [{label: "Direct Access", data: 20}, {label: "Advertisment", data: 15}, {
                label: "Facebook",
                data: 15
            }, {label: "Twitter", data: 30}, {
                label: "Google Plus",
                data: 20
            }], b = App.color.alt2, c = App.color.alt4, d = App.color.alt3, e = App.color.alt1, f = tinycolor(App.color.primary).lighten(5).toString(), g = $("#widget-top-2").parent().next().find(".legend");
            $.plot("#widget-top-2", a, {
                series: {pie: {innerRadius: .5, show: !0, highlight: {opacity: .1}}},
                grid: {hoverable: !0},
                legend: {container: g},
                colors: [b, c, d, e, f]
            })
        ...
        function d() {
            var a = [{label: "Google Ads", data: 70}, {
                label: "Facebook",
                data: 30
            }], b = App.color.alt3, c = tinycolor(App.color.alt4).lighten(6.5).toString();
            $.plot("#widget-top-3", a, {
                series: {pie: {show: !0, label: {show: !1}, highlight: {opacity: .1}}},
                grid: {hoverable: !0},
                legend: {show: !1},
                colors: [b, c]
            })
        ...
        function e() {
            var a = $(".widget-calendar"), b = $(".cal-notes", a), c = $(".day", b), d = $(".date", b), e = new Date, f = new Array(7);
        ...
        function f() {
            var a = ($("#line-chart1"), [[1, 10], [2, 30], [3, 55], [4, 36], [5, 57], [6, 80], [7, 65], [8, 50], [9, 80], [10, 70], [11, 90], [12, 67], [12, 67]]), b = App.color.alt3;
            $.plot("#line-chart1", [{
                data: a,
                showLabels: !0,
                label: "New Visitors",
                ...
                series: {
                    lines: {
                        ...
                        fill: !0,
                        fillColor: {colors: [{opacity: .6}, {opacity: .6}]}
                    }, fillColor: "rgba(0, 0, 0, 1)", points: {show: !0, fill: !0, fillColor: b}, shadowSize: 0
                },
                legend: {show: !1},
                grid: {
                    show: !1,
        ...
        function g() {
            ...
            $("#world-map").vectorMap({
                ...
                markerStyle: {initial: {r: 10}, hover: {r: 12, stroke: "rgba(255,255,255,0.8)", "stroke-width": 4}},
                markers: [{
                    latLng: [41.9, 12.45],
                    name: "1.512 Visits",
                    style: {fill: "#F07878", stroke: "rgba(255,255,255,0.7)", "stroke-width": 3}
                }, {
                    latLng: [1.3, 103.8],
                    name: "940 Visits",
                    style: {fill: "#F07878", stroke: "rgba(255,255,255,0.7)", "stroke-width": 3}
        ...
        function h() {
            var a = [[1, 20], [2, 60], [3, 35], [4, 70], [5, 45]], b = [[1, 60], [2, 20], [3, 65], [4, 35], [5, 65]], c = App.color.alt2;
            $.plot("#linechart-mini1", [{data: a, canvasRender: !0}, {
                data: b,
                canvasRender: !0
            }], {
                series: {
        ...
        function i() {
            var a = tinycolor(App.color.primary).lighten(23).toString(), b = tinycolor(App.color.primary).brighten(5).toString();
            $.plot($("#barchart-mini1"), [{
                data: [[0, 15], [1, 15], [2, 19], [3, 28], [4, 30], [5, 37], [6, 35], [7, 38], [8, 48], [9, 43], [10, 38], [11, 32], [12, 38]],
                label: "Page Views"
            }, {
        ...
        function j() {
            var a = tinycolor(App.color.primary).lighten(6), b = tinycolor(App.color.alt4).lighten(6.5), c = {
        ...
        a(), b(), c(), d();
        var k = App.color.alt2, l = tinycolor(App.color.primary).lighten(5).toString();
    ...
    return App.dashboard2 = function () {
        ...
        function c() {
            var b = [[1, a()], [2, a()], [3, 2 + a()], [4, 3 + a()], [5, 5 + a()], [6, 10 + a()], [7, 15 + a()], [8, 20 + a()], [9, 25 + a()], [10, 30 + a()], [11, 35 + a()], [12, 25 + a()], [13, 15 + a()], [14, 20 + a()], [15, 45 + a()], [16, 50 + a()], [17, 65 + a()], [18, 70 + a()], [19, 85 + a()], [20, 80 + a()], [21, 75 + a()], [22, 80 + a()], [23, 75 + a()]], c = [[1, a()], [2, a()], [3, 10 + a()], [4, 15 + a()], [5, 20 + a()], [6, 25 + a()], [7, 30 + a()], [8, 35 + a()], [9, 40 + a()], [10, 45 + a()], [11, 50 + a()], [12, 55 + a()], [13, 60 + a()], [14, 70 + a()], [15, 75 + a()], [16, 80 + a()], [17, 85 + a()], [18, 90 + a()], [19, 95 + a()], [20, 100 + a()], [21, 110 + a()], [22, 120 + a()], [23, 130 + a()]], d = tinycolor(App.color.primary).lighten(22), e = App.color.primary;
            $.plot($("#line-chart-live"), [{
                data: c,
                showLabels: !0,
                label: "New Visitors",
        ...
        function h() {
            var a = $(".widget-weather"), b = new Skycons({color: "#555555"});
    ...
    return App.mapsVector = function () {
        var a = App.color.alt3, b = App.color.alt2, c = App.color.primary, d = App.color.alt4, e = tinycolor(App.color.alt1).lighten(3).toString(), f = App.color.success, g = tinycolor(App.color.alt4).lighten(5).toString();
        $("#usa-map").vectorMap({
            map: "us_merc_en",
            backgroundColor: "transparent",
            regionStyle: {initial: {fill: a}, hover: {"fill-opacity": .8}}
            ...
            map: "fr_merc_en",
            backgroundColor: "transparent",
            regionStyle: {initial: {fill: b}, hover: {"fill-opacity": .8}}
        }), $("#uk-map").vectorMap({
            map: "uk_mill_en",
            backgroundColor: "transparent",
            regionStyle: {initial: {fill: c}, hover: {"fill-opacity": .8}}
        }), $("#chicago-map").vectorMap({
            map: "us-il-chicago_mill_en",
            backgroundColor: "transparent",
            regionStyle: {initial: {fill: d}, hover: {"fill-opacity": .8}}
            ...
            map: "in_mill_en",
            backgroundColor: "transparent",
            regionStyle: {initial: {fill: f}, hover: {"fill-opacity": .8}}
    ...
    return App.pageProfile = function () {
        function a() {
            var a = [[1, 20], [2, 60], [3, 35], [4, 70], [5, 45]], b = [[1, 60], [2, 20], [3, 65], [4, 35], [5, 65]];
            $.plot("#linechart-mini1", [{data: a, canvasRender: !0}, {
                data: b,
                canvasRender: !0
            }], {
    ...
    return App.dataTables = function () {
        $.extend(!0, $.fn.dataTable.defaults, {dom: "<'row am-datatable-header'<'col-sm-6'l><'col-sm-6'f>><'row am-datatable-body'<'col-sm-12'tr>><'row am-datatable-footer'<'col-sm-5'i><'col-sm-7'p>>"}), $("#table1").dataTable(), $("#table2").dataTable({
            pageLength: 6,
    ...
    return App.uiNotifications = function () {
        $("#not-basic").click(function () {
            ...
            $.gritter.add({title: "Info", text: "This is a simple Gritter Notification.", class_name: "color info"})
...
function updateClock ( )
{
 	var currentTime = new Date ( );
  	...
  	var currentTimeString = currentHours + ":" + currentMinutes + ":" + currentSeconds + " " + timeOfDay;
   	$("#mostrar_reloj").html(currentTimeString);
}
